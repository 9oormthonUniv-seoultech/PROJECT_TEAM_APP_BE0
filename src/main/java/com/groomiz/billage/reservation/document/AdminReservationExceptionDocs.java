...
public class AdminReservationExceptionDocs implements SwaggerExampleExceptions {
	...
	@ExplainError("예약 유형 타입이 올바르지 않은 경우 발생하는 오류입니다.")
	public GlobalCodeException 잘못된_예약_타입 = new AdminReservationException(AdminReservationErrorCode.INVALID_RESERVATION_TYPE);
